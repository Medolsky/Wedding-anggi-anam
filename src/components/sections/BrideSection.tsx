...
export function BrideSection() {
  ...
  return (
    <section
      id="bride"
      data-section="bride"
      className="section-bride relative min-h-screen flex flex-col items-center justify-center text-center overflow-hidden py-18 md:py-24 bg-[#0E0E0F] text-[#C8C5BE] transform-gpu"
    >
