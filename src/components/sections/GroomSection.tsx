    ...
    >
      ...
      <div className="relative z-20 w-full max-w-md mx-auto px-6 text-center flex flex-col items-center justify-center">
        ...
        <AnimatedText delay={0.1} variant="fadeUp" className="w-full text-center mb-2">
          <span
            className="inline-block bg-gradient-to-r from-[#d4af37] via-[#b8860b] to-[#8a662d] text-white text-[10px] md:text-xs font-black uppercase tracking-[4px] px-4 py-1 rounded-full shadow-md"
        ...
        <div className="gold-card-pro p-5 md:p-6 border border-[#d4af37]/60 shadow-2xl w-full max-w-sm text-center flex flex-col items-center">
          {/* Groom Photo Frame */}
          <motion.div
            className="relative w-44 h-56 md:w-52 md:h-64 mx-auto mb-4 rounded-2xl overflow-hidden shadow-[0_12px_30px_rgba(212,175,55,0.25)] border-2 border-[#d4af37]/60 group transform-gpu"
          ...
          {/* Parents & Description */}
          <p
            className="text-center text-xs md:text-sm text-[#1f1d1a] font-semibold leading-relaxed font-serif mb-1"
            style={{ fontFamily: "var(--font-heading)" }}
          >
            {groom.parents}
          </p>
          {groom.description && (
            <p className="text-center text-[10px] text-[#8a662d] font-semibold italic opacity-95 leading-normal mb-3">
              "{groom.description}"
            </p>
          )}
