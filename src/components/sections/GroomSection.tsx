...
export function GroomSection() {
  ...
  return (
    <section
      id="groom"
      data-section="groom"
      className="section-groom relative min-h-screen flex flex-col items-center justify-center text-center overflow-hidden py-18 md:py-24 bg-[#1c0a08] text-white transform-gpu"
    >
      ...
      <div className="relative z-20 w-full max-w-md mx-auto px-6 text-center flex flex-col items-center justify-center">
        ...
        <motion.div
          className="relative w-48 h-60 md:w-56 md:h-70 mx-auto mb-5 rounded-2xl overflow-hidden shadow-[0_12px_35px_rgba(0,0,0,0.7)] border-2 border-[#d4af37]/50 group transform-gpu"
