          ...
          <div className="space-y-6 w-full">
            {loveStory.map((story, index) => (
              ...
              >
                ...
                {/* Card Frame */}
                <div className="gold-card-pro p-4 border border-[#d4af37]/60 flex-1 shadow-xl rounded-2xl">
                  <span
                    className="inline-block text-[9px] font-extrabold uppercase tracking-[2px] text-white bg-gradient-to-r from-[#d4af37] to-[#b8860b] px-2.5 py-0.5 rounded-full mb-2 shadow-xs leading-none"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {story.year}
                  </span>
                  ...
                  <motion.div
                    className="w-full h-36 md:h-40 rounded-xl overflow-hidden shadow-md border border-[#d4af37]/40 group"
